...
This dataset about mental health and music includes 736 responses, and 33 features. We have compared listening habits and effects between each number of listening hours in the aggregate table and the three charts below). There are 27 groups of listening hours. Out of all the respondents, 78.67% listen to music while working/studying, Rock is the most common genre listened to, 73.64% reported improved health, 2.31% reported worsened health, 22.96% reported no effect of music on their mental health, and the remaining 1.09% did not respond to the question. 
